...
class TaskApiReadAllTest extends TestCase{
    //read_all✅
    /*
    public function test_read_all_task_api()
    {
        //$this -> assertEquals()
        //json to php array
        //body della request
        ...
        $response = $this -> get("http://localhost/corso_php_2223/form_in_php/rest_api/tasks.php", $payload);
