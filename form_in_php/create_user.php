...
$validatorRunner=new ValidatorRunner([
    ...
    'birth_city'  => new ValidateRequired('','❗️La città  è obbligatoria😬'),
    'birth_region'  => new ValidateRequired('','❗️La regione è obbligatoria😬'),
    'birth_province'  => new ValidateRequired('','❗️La provincia è obbligatoria😬'),
...
extract($validatorRunner->getValidatorList());
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        //attributo name del form
        /*
        foreach(ValidatorRunner::getAll() as $name_attribute => $istanza_di_validazione){
            $istanza_di_validazione->isValid($_POST[$name_attribute]);
        }
        */
        ...
        */
        ...
        if($first_name->getValid() && $last_name->getValid() && $gender->getValid()){
            //invio i dati a sql per memorizzarli
        }
        */
